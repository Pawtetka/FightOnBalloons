...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        if (/*joystick.Horizontal*/Input.GetAxisRaw("Horizontal") != 0 && !onGround && ButtonDown && SpeedLimit())
        {
            _rb.AddForce(new Vector2(Input.GetAxisRaw("Horizontal")/*joystick.Horizontal*/ * airSpeed * Time.deltaTime, 0));
        }
        else if (onGround && SpeedLimit())
        {
            _rb.AddForce(new Vector2(Input.GetAxisRaw("Horizontal")/*joystick.Horizontal*/ * runSpeed * Time.deltaTime, 0));
        }
